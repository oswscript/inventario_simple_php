			...
			<div class="center">
				<div class="form">
					<form method="post" action="" name="account-settings">
						...
						?>
						<br />
						<input type="submit" name="invento-settings-savesettings" class="ni btn blue" value="Guardar" />
					</form>
				</div>
			<div>
			<?php } ?>
			
			<h2 class="noborder">Cambiar clave</h2>
			<span class="downtitle">Si no desea cambiar su contraseña, deje los siguientes cuadros vacíos.</span>
			<div class="center">
				<div class="form">
					<form method="post" action="" name="change-password">
						...
						Confirme la nueva clave:<br />
						<div class="ni-cont">
							<input type="password" name="rnew-password" class="ni" />
						</div>
						<br />
						<input type="submit" name="invento-settings-changepass" class="ni btn blue" value="Cambiar clave" />
					</form>
				</div>
			</div>
			...
			<div class="center">
				<div class="form">
					<form method="post" action="" name="invento-settings">
						<div class="checkbox"><input type="checkbox" name="allow-namechange" value="y" <?php if($sitedata[0] == 'y') echo 'checked'; ?>/>Permitir a todos los usuarios cambiar su propio nombre.<br /></div>
						<div class="checkbox"><input type="checkbox" name="allow-emailchange" value="y" <?php if($sitedata[1] == 'y') echo 'checked'; ?>/>Permitir a todos los usuarios cambiar su propio correo.<br /></div>
						<br />
