	...
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			...
			<div id="table-head">
				...
				<?php
				if($role == 1 || $role == 2)
					echo '<a href="" name="delete-all" class="btn red disabled fright"><i class="fa fa-close"></i>Borrar productos</a>';
				?>
				<?php /*
				<a href="" name="check-out-all" class="btn blue disabled fright"><i class="fa fa-arrow-up"></i>Restar cantidad</a>
				<a href="" name="check-in-all" class="btn green disabled fright"><i class="fa fa-arrow-down"></i>Agregar cantidad</a>
				*/?>
			</div>
			
			<?php
			if($c_items == 0)
				echo '<br /><br />No existen productos';
			else{
			?>
...
?>
					<tr data-type="element" data-id="<?php echo $item->id; ?>">
						<?php /*<td><input type="checkbox" name="chbox" value="<?php echo $item->id; ?>" /></td>*/?>
						<?php /*<td class="hover" data-type="id"><?php echo $item->id; ?></td> */ ?>
						<td class="hover" data-type="name"><?php echo $item->name; ?></td>
						<td><?php echo $_items->parse_price($item->code); ?></td>
						<td class="hover" data-type="cat"><?php echo $_items->get_category_name($item->category); ?></td>
						<td><?php echo $item->qty; ?></td>
						<td>
							<a href="" name="c1" title="Agregar"><i class="fa fa-arrow-down"></i></a>
							<a href="" name="c2" title="Restar"><i class="fa fa-arrow-up"></i></a>
							<?php
							if($role == 1 || $role == 2 || $role == 3 || $role == 4)
								echo '<a style="background-color: #8CCBFF; padding:4%; font-weight:bold;" href="edit-item.php?id='.$item->id.'" name="c3" title="Editar">Editar<i class="fa fa-pencil"></i></a>';
							//if($role == 1 || $role == 2 || $role == 3)
								//echo '<a href="logs.php?itemid='.$item->id.'" name="c4" title="Log"><i class="fa fa-file-text-o"></i></a>';
							if($role == 1 || $role == 2 || $role == 3)
								echo '<a style="background-color: #FF8989; padding:4%; font-weight:bold;" href="" name="c5" title="Borrar"><i class="fa fa-close"></i>Borrar</a>';
							?>
						</td>
					</tr>
<?php
