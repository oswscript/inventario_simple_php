...
<body>
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			<h2 class="noborder">Sumar productos</h2>
			<span class="downtitle">Haga click en cualquier producto para agrelarle unidades...</span>
			<div id="table-head">
...
?>
					<tr data-id="<?php echo $item->id; ?>">
						...
						<?php /*<td><?php echo $_items->parse_price($item->price); ?></td> */?>
					</tr>
<?php
					}
?>
