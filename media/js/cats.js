$('document').ready(function() {
	...
	$('a[name=c5]').click(function(evt) {
		...
		if(confirm('¿Estás seguro de que deseas eliminar esta categoría? TODOS los productos y registros de esta categoría también se eliminarán.') == true) {
	...
	$('form[name=searchf]').submit(function(evt) {
		...
		if(val == '') {
			$('.loader').fadeOut(200);
			alert('Por favor escriba su busqueda');
			return false;
		}
