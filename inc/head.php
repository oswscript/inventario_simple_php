<?php
$_titles = array('','inicio','Nuevo producto','Productos','Sumar producto','Restar producto','Logs','Categorías','Nueva categoría','Usuarios','Nuevo usuario','Editar usuario','Configurar','Editar producto','Editar categoría','Detalles de la categoría','Detalles de producto','Detalles de usuario');
...
<?php } ?>
	<!--<link type="text/css" href="media/css/all.css" rel="stylesheet">
