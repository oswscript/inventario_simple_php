			...
			<div class="center">
				<div class="new-item form">
					<form method="post" action="" name="edit-item" data-id="<?php echo $itemid; ?>">
						...
						?>
						<span class="item-desc-left">Descripción (<?php echo $desc; ?> characters left):</span><br />
						<div class="ni-cont">
						...
						<div class="select-holder">
							...
							if($_cats->count_cats() == 0)
								echo '<select name="item-category" disabled><option val="no">Necesita crear una nueva categoría primero</option></select></option></select>';
							else{
						...
						<input type="submit" name="item-submit" class="ni btn blue" value="Guardar" />
					</form>
				</div>
			</div>
		</div>
